    ...
    <div>
      <div ref={aboutRef} className={styles.AboutBox}>
        <div className={`description ${styles.description}`}>
          <h1 className={`about ${styles.About}`}>About Me</h1>
          <br />
          {/* <h1>Md.Fahad Ali</h1><br/> */}
          <p className={`des ${styles.des}`}>
            {`
            Hey, I am Md.Fahad Ali.I am from Bangladesh. I enjoy creating 
            things that live on the internet.I like to make websites.
            My main focus is building accessible, inclusive products. 
            `}
          </p>
          <br />
          <br />
          <div className={`social ${styles.scoial}`}>
